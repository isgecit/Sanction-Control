...
Namespace SIS.SYS.Utilities
    ...
    Public Shared Sub Initialize()
      With HttpContext.Current
        .Session("ApplicationID") = 29
        .Session("ApplicationDefaultPage") = "~/Default.aspx"
        .Session("DivisionID") = GetDivision()
      End With
    End Sub
    Public Shared Function GetDivision() As String
      Dim mRet As String = ""
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString)
        Using Cmd As SqlCommand = Con.CreateCommand()
          Dim mSql As String = "select isnull(c_divisionid,'') from hrm_employees where cardno='" & HttpContext.Current.Session("LoginID") & "'"
