...
Namespace SIS.QCM
  ...
  Partial Public Class qcmUsers
    ...
    Private _FK_USR_Department As SIS.QCM.qcmDepartments = Nothing
    ...
    Public ReadOnly Property FK_USR_Company() As SIS.QCM.qcmCompanies
      ...
      End Get
    End Property
    Public ReadOnly Property FK_USR_Department() As SIS.QCM.qcmDepartments
      Get
        If _FK_USR_Department Is Nothing Then
          _FK_USR_Department = SIS.QCM.qcmDepartments.qcmDepartmentsGetByID(_C_DepartmentID)
        End If
    ...
    Public ReadOnly Property FK_USR_Designation() As SIS.QCM.qcmDesignations
      ...
      End Get
    End Property
    Public ReadOnly Property FK_USR_Division() As SIS.QCM.qcmDivisions
      Get
        If _FK_USR_Division Is Nothing Then
          _FK_USR_Division = SIS.QCM.qcmDivisions.qcmDivisionsGetByID(_C_DivisionID)
        End If
    ...
    Public Shared Function qcmUsersSelectList(ByVal OrderBy As String) As List(Of SIS.QCM.qcmUsers)
      ...
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          _RecordCount = -1
          Results = New List(Of SIS.QCM.qcmUsers)()
          Con.Open()
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          While (Reader.Read())
            Results.Add(New SIS.QCM.qcmUsers(Reader))
          End While
          Reader.Close()
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function qcmUsersGetNewRecord() As SIS.QCM.qcmUsers
      Return New SIS.QCM.qcmUsers()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    ...
    Public Shared Function qcmUsersSelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String) As List(Of SIS.QCM.qcmUsers)
      ...
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
					If SearchState Then
						Cmd.CommandText = "spqcmUsersSelectListSearch"
						SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@KeyWord", SqlDbType.NVarChar, 250, SearchText)
					Else
						Cmd.CommandText = "spqcmUsersSelectListFilteres"
					End If
      ...
      Return Results
    End Function
    Public Shared Function qcmUsersSelectCount(ByVal SearchState As Boolean, ByVal SearchText As String) As Integer
      Return _RecordCount
    End Function
...
'		Autocomplete Method
    ...
    Public Sub New(ByVal Reader As SqlDataReader)
      ...
      End If
      If Convert.IsDBNull(Reader("PW")) Then
        _PW = String.Empty
      Else
        _PW = CType(Reader("pw"), String)
      End If
