Partial Class RP_scRMDApproval
  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Dim oVar As SIS.SC.scRMDApproval = SIS.SC.scRMDApproval.scRMDApprovalGetByID(RequestID)
    Dim oTblscRMDApproval As New Table
    oTblscRMDApproval.Width = 1000
    oTblscRMDApproval.GridLines = GridLines.Both
    oTblscRMDApproval.Style.Add("margin-top", "15px")
    oTblscRMDApproval.Style.Add("margin-left", "10px")
    Dim oColscRMDApproval As TableCell = Nothing
    Dim oRowscRMDApproval As TableRow = Nothing
    oRowscRMDApproval = New TableRow
    oColscRMDApproval = New TableCell
    oColscRMDApproval.Text = "Request ID"
    oColscRMDApproval.Font.Bold = True
    oRowscRMDApproval.Cells.Add(oColscRMDApproval)
    oColscRMDApproval = New TableCell
    oColscRMDApproval.Text = oVar.RequestID
      oColscRMDApproval.Style.Add("text-align","right")
    oColscRMDApproval.ColumnSpan = "2"
    oRowscRMDApproval.Cells.Add(oColscRMDApproval)
    oColscRMDApproval = New TableCell
    oColscRMDApproval.Text = "Request Ref. No"
    oColscRMDApproval.Font.Bold = True
    oRowscRMDApproval.Cells.Add(oColscRMDApproval)
    oColscRMDApproval = New TableCell
    oColscRMDApproval.Text = oVar.RequestRefNo
      oColscRMDApproval.Style.Add("text-align","left")
    oColscRMDApproval.ColumnSpan = "2"
    oRowscRMDApproval.Cells.Add(oColscRMDApproval)
    oTblscRMDApproval.Rows.Add(oRowscRMDApproval)
    form1.Controls.Add(oTblscRMDApproval)
